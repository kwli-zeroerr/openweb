				...
				<div class="">
					...
					{:else}
						...
						>
							...
							class="flex-1 flex flex-col relative w-full shadow-sm hover:shadow-md focus-within:shadow-md rounded-3xl border focus-within:ring-1 focus-within:ring-sky-300/40 dark:focus-within:ring-sky-500/20 {$temporaryChatEnabled
									? 'border-dashed border-gray-100 dark:border-gray-800 hover:border-gray-200 focus-within:border-gray-200 hover:dark:border-gray-700 focus-within:dark:border-gray-700'
								: ' border-gray-100/70 dark:border-gray-850/60 hover:border-gray-200 focus-within:border-gray-100 hover:dark:border-gray-800 focus-within:dark:border-gray-800'}  transition px-1 bg-white/40 dark:bg-gray-800/30 backdrop-blur-sm dark:text-gray-100"
