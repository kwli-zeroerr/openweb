					...
					>
						<div class=" self-center flex items-center justify-center size-9">
							<img
								...
								src="{WEBUI_BASE_URL}/zeroerr-logo.jpg"
		...
		>
			...
			>
				...
				<a href="/" class="flex flex-1 px-1.5" on:click={newChatHandler}>
					<div class=" self-center font-semibold text-lg text-gray-850 dark:text-white font-primary">
						{$WEBUI_NAME}
					</div>
				</a>
				<Tooltip
				...
				<div class="pb-1.5">
					<div class="px-[7px] flex justify-center text-gray-800 dark:text-gray-200">
						...
						>
							...
							<div class="flex self-center translate-y-[0.5px]">
								<div class=" self-center text-base font-primary">{$i18n.t('New Chat')}</div>
							</div>
						</a>
					</div>
					...
					<div class="px-[7px] flex justify-center text-gray-800 dark:text-gray-200">
						...
						>
							...
							<div class="flex self-center translate-y-[0.5px]">
								<div class=" self-center text-base font-primary">{$i18n.t('Search')}</div>
							</div>
						</button>
					</div>
					...
					{#if ($config?.features?.enable_notes ?? false) && ($user?.role === 'admin' || ($user?.permissions?.features?.notes ?? true))}
						<div class="px-[7px] flex justify-center text-gray-800 dark:text-gray-200">
							...
							>
								...
								<div class="flex self-center translate-y-[0.5px]">
									<div class=" self-center text-base font-primary">{$i18n.t('Notes')}</div>
								</div>
							</a>
						</div>
					{/if}

					{#if $user?.role === 'admin' || $user?.permissions?.workspace?.models || $user?.permissions?.workspace?.knowledge || $user?.permissions?.workspace?.prompts || $user?.permissions?.workspace?.tools || $user?.permissions?.workspace?.tickets}
						<div class="px-[7px] flex justify-center text-gray-800 dark:text-gray-200">
							<a
							...
							>
								...
								<div class="flex self-center translate-y-[0.5px]">
									<div class=" self-center text-base font-primary">{$i18n.t('Workspace')}</div>
								</div>
							</a>
						</div>
					{/if}
