...
v{VERSION} - building the best AI user interface.
		{f"Commit: {WEBUI_BUILD_HASH}" if WEBUI_BUILD_HASH != "1.2.0" else ""}
...
# Agent API
from open_webui.routers import agent
...
app.include_router(
    model_scoring.router, prefix="/api/v1/model-scoring", tags=["model-scoring"]
)
app.include_router(utils.router, prefix="/api/v1/utils", tags=["utils"])
app.include_router(cleaning_results.router, prefix="/api/v1", tags=["cleaning-results"])
app.include_router(rag_api.router, prefix="/api/v1/rag", tags=["rag"])  # new LangChain-backed router
...
async def get_opensearch_xml():
    ...
    <Image width="16" height="16" type="image/x-icon">{app.state.config.WEBUI_URL}/static/zeroerr-logo.jpg</Image>
...
def swagger_ui_html(*args, **kwargs):
    return get_swagger_ui_html(
        ...
        **kwargs,
        ...
        swagger_favicon_url="/static/swagger-ui/zeroerr-logo.jpg",
    )
